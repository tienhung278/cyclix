...
namespace Cyclix.Migrations
{
    ...
    [Migration("20230624121751_InitDB")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cyclix.Entities.BikeAnotherOption", b =>
                {
                    ...
                    b.HasKey("BikeId", "AnotherOptionId");

                    b.HasIndex("AnotherOptionId");

                    b.ToTable("BikeAnotherOptions");
                });

            modelBuilder.Entity("Cyclix.Entities.BikeOption", b =>
                {
                    b.Property<long>("BikeId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasKey("BikeId", "OptionId");

                    b.HasIndex("OptionId");

                    b.ToTable("BikeOptions");
                });

            modelBuilder.Entity("Cyclix.Entities.BikePackage", b =>
                {
                    b.Property<long>("BikeId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasKey("BikeId", "PackageId");

                    b.HasIndex("PackageId");

                    b.ToTable("BikePackages");
                });
            ...
            modelBuilder.Entity("Cyclix.Entities.BikeAnotherOption", b =>
                {
                    b.HasOne("Cyclix.Entities.AnotherOption", "AnotherOption")
                        .WithMany("BikeAnotherOptions")
                        .HasForeignKey("AnotherOptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Cyclix.Entities.Bike", "Bike")
                        .WithMany("BikeAnotherOptions")
            ...
            modelBuilder.Entity("Cyclix.Entities.AnotherOption", b =>
                {
                    b.Navigation("BikeAnotherOptions");
                });
            ...
            modelBuilder.Entity("Cyclix.Entities.Bike", b =>
                {
                    ...
                    b.Navigation("BikeOptions");

                    b.Navigation("BikePackages");
                });
